...
export default async function decorate(block) {
  ...
  mobileFilterHeaderIcon.innerHTML =
    '<svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 13.5L3.0001 3.5001" stroke="#141414"/><path d="M13 3.5L3.0001 13.4999" stroke="#141414"/></svg>';
  ...
  coveoResultsLoading.className =
    "result-loading-section tw-text-center tw-text-2xl";
